    ...
    <div class="mt-auto pt-4">
      <button
        ...
        :class="{
          ...
          'hover:bg-gray-50': isAllRequiredFilled && !isLoading
        }"
        class="relative inline-flex min-h-11 w-full items-center justify-center rounded-md border border-gray-700 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
      >
        <span
...
const buttonLabel = computed(() => (props.isEditMode ? 'Save changes' : 'Launch for Free'));
