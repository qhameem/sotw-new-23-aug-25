  ...
  >
    ...
    <div class="mt-auto pt-4">
      <button
        ...
        class="w-full flex justify-center py-2 border border-gray-700 text-sm font-medium rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
      >
        <span v-if="!isLoading">{{ isEditMode ? 'Save changes' : 'Launch for Free' }}</span>
