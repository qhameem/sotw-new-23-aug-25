  ...
  >
    ...
    <div class="mt-auto pt-4">
      <button
        ...
        class="w-full flex justify-center py-2 border border-transparent text-sm font-medium rounded-md text-white bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-50"
      >
        <span v-if="!isLoading">{{ isEditMode ? 'Save changes' : 'Submit with Badge' }}</span>
