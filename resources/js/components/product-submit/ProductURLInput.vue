<template>
  <!-- Root: Fills available parent height (flex-1) -->
  <div class="relative w-full h-full flex-1 bg-white flex flex-col">
    ...
    <div class="flex-grow flex items-center w-full relative z-10">
      <!-- Standard Site Container: Aligns with Logo -->
