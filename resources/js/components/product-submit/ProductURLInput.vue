  ...
  <div class="bg-sky-50/50 p-6 rounded-2xl border border-sky-100 mb-8">
    ...
    <div class="flex items-center gap-3">
      ...
      <button
        ...
        :disabled="isLoading"
        :class="[
          'px-6 py-2 text-white font-bold rounded-md text-sm flex items-center gap-2 shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 whitespace-nowrap transition-all duration-200',
          isLoading ? 'bg-sky-400 cursor-wait' : 'bg-sky-500 hover:bg-sky-600 hover:shadow-lg'
        ]"
      >
        <span v-if="isLoading" class="flex items-center gap-2">
          ...
          {{ loadingProgress > 0 && loadingProgress < 10 ? 'Starting...' : 'Fetching...' }}
        </span>
