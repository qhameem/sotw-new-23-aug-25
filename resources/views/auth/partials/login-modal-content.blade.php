    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-6" aria-label="Tabs">
            <a href="#" @click.prevent="activeTab = 'login'"
               :class="{ 'border-primary-500 text-primary-600': activeTab === 'login', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'login' }"
               class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Sign In
            </a>
            <a href="#" @click.prevent="activeTab = 'register'"
               :class="{ 'border-primary-500 text-primary-600': activeTab === 'register', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'register' }"
               class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Sign Up
            </a>
        </nav>
