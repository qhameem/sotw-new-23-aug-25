...
@section('content')
    <div class="mx-auto w-full max-w-[1500px] px-4 py-8 sm:px-6 lg:px-10 xl:px-12">
        <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-[0_24px_80px_-48px_rgba(15,23,42,0.35)]">
            <div class="border-b border-gray-100 bg-white px-6 py-8 sm:px-8 lg:px-10 xl:px-12">
                ...
                <div class="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    <div class="rounded-xl border border-white/70 bg-white/80 p-5 shadow-sm backdrop-blur">
            ...
            <div class="grid gap-0 border-t border-gray-100 xl:grid-cols-[380px_minmax(0,1fr)]">
                <aside class="border-b border-gray-100 bg-gray-50/70 p-6 xl:border-b-0 xl:border-r xl:p-8">
                    <div class="xl:sticky xl:top-6 space-y-6">
                        <div id="create-collection" class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-900 text-sm font-semibold text-white">
                                    +
                                </div>
                            </div>
                            ...
                            <form method="POST" action="{{ route('collections.store') }}" class="mt-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <select id="collection_visibility" name="visibility" class="mt-2 block w-full rounded-xl border-gray-200 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-6 text-gray-900">
                ...
                <section class="bg-white p-6 xl:p-8">
                    ...
                    <div class="mt-6">
                        @forelse($collections as $collection)
                            ...
                            <article class="group flex h-full flex-col rounded-xl border border-gray-200 bg-[linear-gradient(180deg,_#ffffff_0%,_#f8fafc_100%)] p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-lg">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="min-w-0">
                                        <div class="flex items-center gap-3">
                                            <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl {{ $collection->visibility === 'public' ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-700' }}">
                                ...
                                <form method="POST" action="{{ route('collections.update', $collection) }}" class="mt-5 space-y-4 rounded-xl border border-gray-200 bg-white p-4">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div>
                                        ...
                                        <select id="{{ $collectionVisibilityFieldId }}" name="visibility" class="mt-2 block w-full rounded-xl border-gray-200 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            @endif
                        @empty
                            <div class="rounded-xl border border-dashed border-gray-300 bg-[linear-gradient(180deg,_#ffffff_0%,_#f8fafc_100%)] px-6 py-14 text-center">
                                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-xl bg-gray-100 text-2xl text-gray-500">
                                    +
                                </div>
