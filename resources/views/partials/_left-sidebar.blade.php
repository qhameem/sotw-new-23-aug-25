    ...
    <div class="hidden md:flex flex-grow p-4 pl-8 ml-8">
        <nav class="flex flex-col space-y-2 text-base">
            ...
            <a href="{{ route('promote') }}" class="flex items-center p-2 text-gray-900 rounded-lg  group">
                <svg class="size-6 group-hover:text-gray-900 -rotate-45 @if(request()->routeIs('promote')) text-primary-500 @else text-gray-400 @endif" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor">
    ...
    <div class="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200  ">
        <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
            ...
            <a href="{{ route('articles.index') }}" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 ">
                ...
                <span class="text-xs @if(request()->routeIs('articles.index') || request()->routeIs('articles.show') || request()->routeIs('articles.category') || request()->routeIs('articles.tag')) text-primary-500 font-semibold @else text-gray-500 @endif ">Articles</span>
            </a>
            <a href="{{ route('promote') }}" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 mb-1 @if(request()->routeIs('promote')) text-primary-500 @else text-gray-500 @endif "><path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.432 0l6.568-6.568a2.426 2.426 0 0 0 0-3.432L12.586 2.586z"/><path d="M7 7h.01"/></svg>
                <span class="text-xs @if(request()->routeIs('promote')) text-primary-500 font-semibold @else text-gray-500 @endif ">Pricing</span>
            </a>
        </div>
    </div>
</div>