...
@section('title', 'Launch Readiness Checker - Software on the Web')
@section('og_title', 'Check if your site is ready for launch')
@section('meta_description', 'Free homepage audit for launch readiness, SEO basics, and AI visibility signals.')
@section('schema')
    @php
        $schema = [
...
@section('content')
    <div
        ...
        x-data="launchReadinessAnalyzer({ csrfToken: @js(csrf_token()), initialNotice: '' })"
    >
        <section class="pt-4 text-center">
            ...
            <h1 class="mt-5 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">Is your site ready for launch?</h1>
            ...
            >
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div class="flex h-12 items-center rounded-2xl border border-slate-200 bg-slate-50 px-4">
                        ...
                        <input id="url" name="url" type="text" value="{{ old('url') }}" placeholder="https://your-site.com" class="h-full w-full border-0 bg-transparent p-0 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-0">
                    </div>
                </div>
