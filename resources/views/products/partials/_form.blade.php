...
<div class="space-y-6">
    ...
    <div class="grid md:grid-cols-4 gap-4 items-start">
        ...
        <div class="md:col-span-3">
            ...
            <div x-show="!logoPreviewUrl" @click="document.getElementById('logoInput').click()" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-primary-500 transition-colors duration-150 ease-in-out">
