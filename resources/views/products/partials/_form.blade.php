        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            ...
            <div x-show="showCategories"
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xs text-gray-600">At least 1 and upto 3</span>
                </div>
            ...
            <!-- Pricing Model -->
            <div class="mb-4">
                <h3 class="text-sm font-semibold text-gray-600 mb-2">Pricing Model<span class="text-red-500 text-xs"><span class="text-red-500 ml-1">*</span> (select at least one)</span></h3>
    ...
    <div class="p-4 border rounded-lg">
        ...
        <div class="space-y-4">
            ...
            <div class="mt-4">
                ...
                <input type="file" name="media" id="mediaInput" class="hidden" accept="image/png,image/jpeg,image/gif">
